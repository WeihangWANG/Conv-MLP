...
class FusionNet(nn.Module):
    ...
    def __init__(self, num_class=2):
        ...
        self.bottleneck = nn.Sequential(nn.Conv2d(512*2, 128*2, kernel_size=1, padding=0),
                                         nn.BatchNorm2d(128*2),
                                         nn.ReLU(inplace=True))

        self.res_0 = self._make_layer(BasicBlock, 128*2, 256, 2, stride=2)
    ...
    def forward(self, x):
        ...
        fea = torch.cat([depth_feas, ir_feas], dim=1)
