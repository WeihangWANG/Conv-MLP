...
class Net(nn.Module):
    ...
    def __init__(self, num_class=2, id_class = 300, is_first_bn = False):
        ...
        # self.shortcut_whole = self.encoder.shortcut_whole
    ...
    def forward_res3(self, x):
        ...
        x1 = self.conv1(x) #; print('e1',x.size())

        # x3 = self.shortcut_whole(x1)
        x1 = self.conv2(x1) #; print('e2',x.size())
        x1 = self.conv3(x1) #; print('e3',x.size())
        # x3 = x3 + x1
